...
Yanfly.StatAlc.version = 1.00;

//=============================================================================
 /*:
 * @plugindesc v1.00 Add a menu to your game to allocate stats for party
...
Yanfly.Param.StatAlcShowCmd = eval(Yanfly.Param.CCCShowCmd);
Yanfly.Param.StatAlcEnableCmd = String(Yanfly.Parameters['Enable Command']);
Yanfly.Param.StatAlcEnableCmd = eval(Yanfly.Param.CCCEnableCmd);
Yanfly.Param.StatAlcAutoPlace = String(Yanfly.Parameters['Auto Place Command']);
Yanfly.Param.StatAlcAutoPlace = eval(Yanfly.Param.CCCAutoPlace);
